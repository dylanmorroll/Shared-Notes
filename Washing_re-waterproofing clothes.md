...
# When to wash
- Whenever necessary (if there is noticeable grime/odours that you don't want to set into the fabric).
- At the end of the season, if applicable.
- Around every 6-12 months.
- Before storing for a long time. (If barely used, inspect for noticeable stains/odours, but probably wash. If it's going into storage for half a year/ a year/ longer, then you're still not washing it very often. Also it's hard to get stains/odours out of technical gear once it's in.)

(TX Direct withstands 4-6 washes with Tech Wash [[Nikwax FAQ]].)

# When to re-waterproof
- When washing or tumble drying alone doesn't bring back the beading of water on the surface
- "For an average use of outdoor clothing we recommend that you wash and re-proof your gear at least once a year." [[Nikwax FAQ]]
- Basically if you're doing a big once-a-year of end-of-season wash, may as well re-waterproof it whilst you're there
...
3. Do up any zips and velcro on the garments. (With velcro fully do it so there's no visible half left, otherwise it will stick to random things in the wash and can pull the fabric.)
...
## Using a bag with top loaders
> If using a top loader (agitator), protect your garment inside a mesh bag for added protection. (If you don't have a mesh bag, don't worry. We use Guppy bags [microplastic catch bags] at our Service Centres, or putting your garment in a pillowcase can also work in a pinch.)

[[How To Wash Arc’teryx Product Care | Arc'teryx]]

Some people recommend always using a bag when washing insulation. See '[Using a bag with insulating items](#using-a-bag-with-insulating-items)' below.
...
## Tumble drying
Supposedly Nikwax doesn't need heat/ to tumble dry, but then their FAQ says "Nikwax products will achieve the same, if not better standard of water-repellency than competitor products without using heat." [[Nikwax FAQ]] Does this just mean it's better than other products if they're used without heat?
...
# Insulating items
Check label to see if it's synthetic or not. Also see [insulating items](../../Outdoors/Maintenance/Insulating%20items.md).

## Using a bag with insulating items
Some people recommend always using a bag for synthetic items:

>  Put your fleeces and wools in a microfiber catching bag. This is a fine mesh bag that traps the harmful micro fibers that fall out. It also has the benefit to being more gentle on the garment (I think it’s between hand washing and “gentle wash”). I’ve taken to using one for washing anything I’m worried will pill up and it seems to work well.

[[How often should you wash Synthetic Mid-Layers? : r/arcteryx]]

In a pinch, you can use a pillow case. See '[Using a bag with top loaders](#using-a-bag-with-top-loaders)' above.
...
> [After washing] Rinse extremely thoroughly (at least twice).

> During drying, occasionally tease apart any clumps of down with your hands... If using a tumble drier, drying can be aided by adding a couple of tennis balls or other small but firm items to the drum.
...
[[Caring for Insulated Clothing – Mountain Equipment]]
...
> The same goes for synthetic insulated jackets as for all your outdoor gear: As frequently as necessary, but as seldom as possible!

[[How to Wash & Care Synthetic Insulated Jackets | Care Tips | Alpinetrek]]

> For synthetic bags, tennis balls are helpful but optional.
...
# Sources
[Nikwax FAQ]: https://nikwax.com/en-us/faq/
- [Nikwax FAQ]
...
[How To Wash Arc’teryx Product Care | Arc'teryx]: https://arcteryx.com/nl/en/help/product-care/wash-dry-synthetic-insulation
- [How To Wash Arc’teryx Product Care | Arc'teryx]

[How often should you wash Synthetic Mid-Layers? : r/arcteryx]: https://www.reddit.com/r/arcteryx/comments/dpbc2z/how_often_should_you_wash_synthetic_midlayers/
- [How often should you wash Synthetic Mid-Layers? : r/arcteryx]

[Caring for Insulated Clothing – Mountain Equipment]: https://www.mountain-equipment.com/pages/caring-for-insulated-clothing
- [Caring for Insulated Clothing – Mountain Equipment]
